    ...
    <div class="app-container calendar-list-container">
        <div v-show="formVisible">
            ...
            <div v-for="(item,key) in remitForm" :key="key">
                银行：<el-select v-model="item.bank_code" filterable clearable placeholder="请选择">
                        <el-option
                ...
                卡号：<el-input v-model="item.bank_number" style="width: 180px;margin-bottom: 10px" ></el-input>
                姓名：<el-input v-model="item.real_name" style="width: 180px;margin-bottom: 10px"></el-input>
                金额：<el-input v-model="item.amount" style="width: 180px;margin-bottom: 10px"></el-input>
                <el-button class="filter-item" @click="handleDel" v-waves>删除</el-button>
            </div>
            <div align="center">
                <el-button class="filter-item" @click="handleNext" v-waves>下一步</el-button>
                <el-button class="filter-item" @click="handleAppend" v-waves>增加</el-button>
            </div>
        </div>
        <div v-show="confirmVisible" align="center">
            <h4>确认提款信息</h4>
            <el-table :data="remitForm" align="center" border fit highlight-current-row style="width: 70%;font-size: 12px;" stripe>
    ...
    export default {
        ...
        methods:{
            ...
            batchSubmit(){
                ...
                let data={financial_password_hash:this.financial_password_hash,key_2fa:this.key_2fa,remitData:this.remitForm}
