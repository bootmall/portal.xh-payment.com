                ...
                <el-col :span="22" :offset="1">
                    <div class="grid-content bg-purple">
                        ...
                        <el-form-item :label="item" v-for="(item,key) in payTypeOptions" :key="key">
                            <el-input style="width: 150px" prop="pay_method" v-model="commonForm.recharge_rate[key]" placeholder="请输入手续费率‰"></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            selectChannel(channels) {
                ...
                return;
                var self = this
                let idx = _.findIndex(self.channelList, function(o) { return o.id == self.commonForm.channel; });
