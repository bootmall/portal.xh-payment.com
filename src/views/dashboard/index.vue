<template>
    <div>
        ...
        <el-row :gutter="20" style="margin-left: 50px;line-height: 60px;width: 90%;">
          ...
          <!--</el-container>-->
          <el-tabs tab-position="left" style="height: 200px;overflow:auto;" class="notice-list">
            ...
            <el-tab-pane :label="item.title" v-for="(item,key) in notice" :key="key" v-html="item.content" @click="content = item.content"></el-tab-pane>
          </el-tabs>
        </el-row>
