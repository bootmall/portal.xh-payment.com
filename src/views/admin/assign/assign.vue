    ...
    methods: {
      ...
      handleCheckAllChange(val) {
        ...
        for (let i = 0; i < this.allPermissions.length; i++) {
          console.log(this.allPermissions[i].name);
          if(typeof this.allPermissions[i].children!='undefined'){
            for (let k = 0; k < this.allPermissions[i].children.length; k++) {
              this.rolePermissions.push(this.allPermissions[i].children[k].name)
            }
          }
      ...
      selectReverse() {
        ...
        for (let i = 0; i < this.allPermissions.length; i++) {
          ...
          if(typeof this.allPermissions[i].children!='undefined'){
            for (let k = 0; k < this.allPermissions[i].children.length; k++) {
              let idx = _.indexOf(this.rolePermissions, this.allPermissions[i].children[k].name)
              if (idx < 0) {
                newSelect.push(this.allPermissions[i].children[k].name)
              }
            }
          }
