...
// webPackIndex: path.resolve(__dirname, '../dist/prod/index.html'),
//   webPackssetsRoot: path.resolve(__dirname, '../dist/prod'),
// process.exit()
...
var webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    path: webPackssetsRoot,//config.build.assetsRoot,
